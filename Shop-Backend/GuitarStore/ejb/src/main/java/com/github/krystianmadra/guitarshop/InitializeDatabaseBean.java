...
public class InitializeDatabaseBean {
    ...
    public void init(){
        ...
        GuitarEntity electric2 = new GuitarEntity("Cort G220 CAR", 699.0, 2,"Cort G220 CAR Wygodna gitara elektryczna, która dzięki podwójnemu wycięciu \"cutaway\" umożliwia ułatwiony dostęp do wysokich rejestrów", electric,"https://i.ibb.co/k5L7HcH/1.png");
        ...
        GuitarEntity electric5 = new GuitarEntity("ESP LTD M-50 FR NGR", 1199.0, 2,"ESP LTD M-50 FR NGR Bardzo ciekawa propozycja dla gitarzystów, którzy lubią się wyróżniać. M-50 FR NGR wyposażono w ruchomy most tremolo", electric,"https://i.ibb.co/JQKB2R7/4.png");
        ...
        GuitarEntity electric8 = new GuitarEntity("Ibanez GART60 WNS", 899.0, 2,"Ibanez GART60 WNS Nowa gitara elektryczna marki Ibanez z serii GIO. Model o szczególnie pozytywnym stosunku jakości do ceny", electric,"https://i.ibb.co/F6mQTcX/7.png");
        ...
        GuitarEntity classic3 = new GuitarEntity("Ortega R122", 699.0, 2,"Ortega R122 Wyjątkowy instrument o rozmiarze 4/4, świetnej selekcji drewna oraz pięknej stylistyce Ortega R122 cechuje się brzmieniem wyraźnym i głośnym",classic,"https://i.ibb.co/8dynzTC/2.png");
        ...
        GuitarEntity classic5 = new GuitarEntity("Yamaha CG142C", 999.0, 2,"Yamaha CG142C Znakomita gitara klasyczna, perfekcyjnie wykonana z najlepszych materiałów. Świetne brzmienie i duży komfort gry",classic,"https://i.ibb.co/WVhfYnM/4.png");
        ...
        GuitarEntity classic9 = new GuitarEntity("Alvarez RC 26", 589.0, 2,"Alvarez RC 26 Piękna gitara klasyczna marki Alvarez słynącej z tradycji ręcznego wytwarzania instrumentów, świetnie dobranego drewna i precyzji wykonania",classic,"https://i.ibb.co/RgsWngR/8.png");
        GuitarEntity classic10 = new GuitarEntity("Ever Play C-200", 429.0, 2,"Ever Play C-200 Świetna gitara klasyczna marki Ever Play. Model wykonany precyzyjnie z najwyższej jakości drewna, co wpywa na przyjemne i ciepłe brzmienie",classic,"https://i.ibb.co/wQcQwjB/9.png");
        ...
        GuitarEntity acoustic2 = new GuitarEntity("Fender FA-125 Dreadnought", 439.0, 2,"Fender FA-125 Dreadnought BLK Nowa gitara akustyczna marki Fender z serii FA. Model jest idealnym rozwiązaniem dla muzyków poszukujacych porządnej gitary akustycznej",acoustic,"https://i.ibb.co/BLQRNBs/1.png");
        ...
        GuitarEntity acoustic6 = new GuitarEntity("Yamaha F370 NT", 599.0, 2,"Yamaha F370 NT Jedna z najczęściej wybieranych gitar akustycznych. Yamaha F-370 swoją popularność zawdzięcza świetnemu wykonaniu a co za tym idzie, komfortowi gry",acoustic,"https://i.ibb.co/LxxGWWQ/5.png");
        ...
        GuitarEntity acoustic8 = new GuitarEntity("Alvarez AD 60 N", 1399.0, 2,"Alvarez AD 60 N Piękna gitara akustyczna marki Alvarez słynącej z tradycji ręcznego wytwarzania instrumentów, świetnie dobranego drewna i precyzji wykonania",acoustic,"https://i.ibb.co/pzYj5Lq/7.png");
        GuitarEntity acoustic9 = new GuitarEntity("Cort AD810 12 OP", 489.0, 2,"Cort AD810 12 OP Doskonała 12-strunowa gitara akustyczna wykonana z najwyższej jakości drewna. Zapewnia ciepłe i przejrzyste brzmienie",acoustic,"https://i.ibb.co/df5Wj0V/8.png");
        ...
        GuitarEntity bass3 = new GuitarEntity("Marcus Miller M7 Alder-4", 1699.0,2,"Marcus Miller M7 Alder-4 TBL Genialne gitary basowe zbudowane w ścisłej współpracy z legendą muzyki-Marcusem Millerem", bass,"https://i.ibb.co/SRzyNnt/2.png");
        ...
        GuitarEntity bass7 = new GuitarEntity("Cort Action Bass PJ OPB", 579.0,2,"Cort Action Bass PJ OPB Basówki marki cort to gwarancja porządnego wykonania każdego jednego egzemplarza oraz dość dużej wygody gry", bass,"https://i.ibb.co/6YZ0HW0/6.png");
        GuitarEntity bass8 = new GuitarEntity("Cort C4 Plus ZBMH OTAB", 1285.0,2,"Cort C4 Plus ZBMH OTAB 4-strunowa gitara basowa marki Cort. Model z serii Artisan został zbudowany z najwyzszej jakości materiałów", bass,"https://i.ibb.co/m4dtdYc/7.png");
        ...
        GuitarEntity bass10 = new GuitarEntity("Fender Player Jazz Bass", 3089L,2,"Fender Player Jazz Bass MN PWT Najnowsze jazzbasy z serii Player to doskonała jakość wykonania oraz gwarancja satysfakcji i niezawodności", bass,"https://i.ibb.co/BzRc20D/9.png");
